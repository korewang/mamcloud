define(['app','config/base','entities/workspace/item','backbone.validation',"backbone.paginator"],function(CloudMAM,baseConfig,Item){
    ...
    var ItemCollection = Backbone.PageableCollection.extend({
        ...
        initialize: function(params,options){
            ...
            this.listenTo(this.parameters,"change:folderCode",this.folderCodeBy);//数据文件夹的时候操作
        ...
        pageBy: function(params){//翻页滚动
            ...
            this.getPage(page,{reset:true}).done(function(){
               ...
               /// console.log("合并以后:",self.models);
                CloudMAM.trigger('list:xscroll:refresh');//发生trigger  listControl接收   refresh  滚动条
            });
        },
    ...
    CloudMAM.reqres.setHandler('workspace:item:list',function(params){
